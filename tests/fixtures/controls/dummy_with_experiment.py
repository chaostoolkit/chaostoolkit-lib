...
def before_hypothesis_control(
    experiment: Experiment, context: Hypothesis, **kwargs: Any
) -> None:
...
def after_hypothesis_control(
    experiment: Experiment, context: Hypothesis, state: Dict[str, Any], **kwargs: Any
) -> None:
...
def before_activity_control(
    experiment: Experiment, context: Activity, **kwargs: Any
) -> None:
...
def after_activity_control(
    experiment: Experiment, context: Activity, state: Run, **kwargs: Any
) -> None:
